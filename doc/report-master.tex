...
Además, se utiliza programación en paralelo para obtener una mejor utilización de la capacidad de cómputo disponible; aumentando por lo tanto la complejidad de implementación, depuración y
optimización \cite{is-parallel-programming-hard}.
...
optimizadas profundamente y con correctitud comprobada.
...
\item Apéndice \ref{contributions}: contiene las publicaciones realizadas.
...
\section{Estudio de Multiplicación de Matrices}
...
\section{\it Optimizing Latency in Beowulf Clusters}
...
\section{Comparación de Implementaciones de una Operación BLAS}
...
\section{Contribuciones en el Libro {\it Programming Intel Xeon Phi}}
