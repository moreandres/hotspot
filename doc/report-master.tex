...
Los investigadores suelen utilizar programación en paralelo para obtener una mejor utilización de la capacidad de cómputo disponible. Esto aumenta por lo tanto la complejidad de implementación, depuración y
...
medición tanto como sea posible. También es preferible aumentar el tamaño del problema a resolver, o la definición de los resultados, para ejercitar por más tiempo y tener así un resultado más estable.
Suponiendo una distribución normal de resultados, se suele controlar que haya menos de 3 desviaciones estándar de diferencia como prueba de normalidad \cite{stddevbook}.
...
\item Comprobar variación de resultados para conocer la estabilidad de los mismos. La desviación estándar debe ser menor a 3 desviaciones asumiendo distribución normal. 
